...
import { isPitchDemo, markPitchDemoReady, pitchDemoBoot } from "@/lib/pitch-demo";
...
export function IngestClient({ demo = false }: { demo?: boolean }) {
  ...
  const [queue, setQueue] = useState<QueueItem[]>(() =>
    boot
      ? [
          {
            file: new File(["demo"], "hackathon-notice.pdf", { type: "application/pdf" }),
            status: "done",
            announcement: boot.notice,
          },
        ]
      : [],
  );
